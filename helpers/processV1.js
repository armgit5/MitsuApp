...
module.exports = (mainWindow) => {
    ...
    ipcMain.on(machine.commChannels.speed, (e, speed) => {
        MACHINE_SPEED = speed;
    ...
    ipcMain.on(machine.commChannels.speedUp, (e, isSet) => {
    ...
    ipcMain.on(machine.commChannels.speedUpVal, (e, val) => {
    ...
    ipcMain.on(machine.commChannels.speedDown, (e, isSet) => {
    ...
    ipcMain.on(machine.commChannels.torque, (e, torque) => {
